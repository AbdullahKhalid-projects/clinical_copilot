...
import { currentDoctor, appointments, todaysOverview } from "@/lib/mockData";
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-primary-foreground/80">{currentDoctor.specialty}</p>
              <p className="text-primary-foreground/80">{currentDoctor.title}</p>
