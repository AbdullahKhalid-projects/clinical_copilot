...
async function main() {
  ...
  await db.medicineCatalog.createMany({
    data: medications.map((medication) => ({
      ...
      activeIngredients: medication.activeIngredients.join("; "),
      primekgQueryTerms: medication.primekgQueryTerms.join("; "),
      matchConfidence: medication.matchConfidence,
      mappingNotes: medication.mappingNotes,
